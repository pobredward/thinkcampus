...
const styles = StyleSheet.create({
  ...
  emoji: { fontSize: 56 },
  title: { marginTop: 16, fontSize: 24, fontWeight: '800', color: '#f2f2f0' },
  desc: { marginTop: 12, fontSize: 17, lineHeight: 27, color: '#d4d7dd', textAlign: 'center' },
  btn: {
    marginTop: 40,
    width: '100%',
    maxWidth: 320,
  ...
  btnText: { fontSize: 17, fontWeight: '700', color: '#0c0e13' },
});
